@component('user1.layouts.content', [
                ...
                <div class="card-body pb-0">
                  <div class="d-flex mb-3 hover-actions-trigger align-items-center">
                    ...
                    <div class="ms-3 flex-shrink-1 flex-grow-1">
                      ...
                      <div class="hover-actions end-0 top-50 translate-middle-y"><a class="btn btn-tertiary border-300 btn-sm me-1 text-600" data-bs-toggle="tooltip" data-bs-placement="top" title="Download" href="{{ asset('falcon/public/assets/img/icons/cloud-download.svg') }}" download="download"><img src="assets/img/icons/cloud-download.svg" alt="" width="15" /></a>
