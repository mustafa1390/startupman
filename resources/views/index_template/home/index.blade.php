@component('index_template.layouts.content', [
    'title' => __('message.dir'),
    'tabTitle' => __('message.dir'),
    'breadcrumb' => [['title' => 'لیست مدیران', 'url' => '#'], ['title' => 'ایجاد ادمین جدید', 'class'
    => 'active']],
    ])
                    ...
                    <div class="row">
                        <div class="col-12 pages-title">
                            ...
                            <div class="icon-background">
                                <img class="absolute item1" src="{{ asset('index_template/index/assets/images/item-background/item1.png')}}" alt="">
                                <img class="absolute item2" src="{{ asset('index_template/index/assets/images/item-background/item2.png')}}" alt="">
                                <img class="absolute item3" src="{{ asset('index_template/index/assets/images/item-background/item3.png')}}" alt="">
                                <img class="absolute item4" src="{{ asset('index_template/index/assets/images/item-background/item1.png')}}" alt="">
                                <img class="absolute item5" src="{{ asset('index_template/index/assets/images/item-background/item1.png')}}" alt="">
                                <img class="absolute item6" src="{{ asset('index_template/index/assets/images/item-background/item4.png')}}" alt="">
                                <img class="absolute item7" src="{{ asset('index_template/index/assets/images/item-background/item5.png')}}" alt="">
                                <img class="absolute item8" src="{{ asset('index_template/index/assets/images/item-background/item5.png')}}" alt="">
                            </div>
                            <div class="relative">
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="tf-card-box">
                                                <div class="card-media">
                                                    <a href="#">
                                                        <img src="{{ asset('index_template/index/assets/images/box-item/banner-01.jpg')}}" alt="">
                                                    </a>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-card-box">
                                                <div class="card-media">
                                                    <a href="#">
                                                        <img src="{{ asset('index_template/index/assets/images/box-item/banner-02.jpg')}}" alt="">
                                                    </a>
                                                    <span class="wishlist-button icon-heart"></span>
                                                    <div class="featured-countdown">
                                                        <span class="js-countdown" data-timer="7500" data-labels="d,h,m,s"></span>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-card-box">
                                                <div class="card-media">
                                                    <a href="#">
                                                        <img src="{{ asset('index_template/index/assets/images/box-item/banner-03.jpg')}}" alt="">
                                                    </a>
                                                    <span class="wishlist-button icon-heart"></span>
                                                    <div class="featured-countdown">
                                                        <span class="js-countdown" data-timer="7500" data-labels="d,h,m,s"></span>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-card-box">
                                                <div class="card-media">
                                                    <a href="#">
                                                        <img src="{{ asset('index_template/index/assets/images/box-item/banner-04.jpg')}}" alt="">
                                                    </a>
                                                    <span class="wishlist-button icon-heart"></span>
                                                    <div class="featured-countdown">
                                                        <span class="js-countdown" data-timer="7500" data-labels="d,h,m,s"></span>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-card-box">
                                                <div class="card-media">
                                                    <a href="#">
                                                        <img src="{{ asset('index_template/index/assets/images/box-item/banner-05.jpg')}}" alt="">
                                                    </a>
                                                    <span class="wishlist-button icon-heart"></span>
                                                    <div class="featured-countdown">
                                                        <span class="js-countdown" data-timer="7500" data-labels="d,h,m,s"></span>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-card-box">
                                                <div class="card-media">
                                                    <a href="#">
                                                        <img src="{{ asset('index_template/index/assets/images/box-item/banner-06.jpg')}}" alt="">
                                                    </a>
                                                    <span class="wishlist-button icon-heart"></span>
                                                    <div class="featured-countdown">
                                                        <span class="js-countdown" data-timer="7500" data-labels="d,h,m,s"></span>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-card-box">
                                                <div class="card-media">
                                                    <a href="#">
                                                        <img src="{{ asset('index_template/index/assets/images/box-item/banner-07.jpg')}}" alt="">
                                                    </a>
                                                    <span class="wishlist-button icon-heart"></span>
                                                    <div class="featured-countdown">
                                                        <span class="js-countdown" data-timer="7500" data-labels="d,h,m,s"></span>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="tf-card-box style-1">
                                            <div class="card-media">
                                                <a href="#">
                                                    <img src="{{ asset('index_template/index/assets/images/box-item/card-item-01.jpg')}}" alt="">
                                                </a>
                                                <span class="wishlist-button icon-heart"></span>
                                                <div class="featured-countdown">
                                                    <span class="js-countdown" data-timer="7500" data-labels="d,h,m,s"></span>
                                            ...
                                            <div class="author flex items-center">
                                                <div class="avatar">
                                                    <img src="{{ asset('index_template/index/assets/images/avatar/avatar-box-01.jpg')}}" alt="Image">
                                                </div>
                                                <div class="info">
                                    ...
                                    <div  class="swiper-slide">
                                        <div class="tf-card-box style-1">
                                            <div class="card-media">
                                                <a href="#">
                                                    <img src="{{ asset('index_template/index/assets/images/box-item/card-item-02.jpg')}}" alt="">
                                                </a>
                                                <span class="wishlist-button icon-heart"></span>
                                                <div class="featured-countdown">
                                                    <span class="js-countdown" data-timer="7500" data-labels="d,h,m,s"></span>
                                            ...
                                            <div class="author flex items-center">
                                                <div class="avatar">
                                                    <img src="{{ asset('index_template/index/assets/images/avatar/avatar-box-02.jpg')}}" alt="Image">
                                                </div>
                                                <div class="info">
                                                    <span>Created by:</span>
                                    ...
                                    <div  class="swiper-slide">
                                        <div class="tf-card-box style-1">
                                            <div class="card-media">
                                                <a href="#">
                                                    <img src="{{ asset('index_template/index/assets/images/box-item/card-item-03.jpg')}}" alt="">
                                                </a>
                                                <span class="wishlist-button icon-heart"></span>
                                                <div class="featured-countdown">
                                                    <span class="js-countdown" data-timer="7500" data-labels="d,h,m,s"></span>
                                            ...
                                            <div class="author flex items-center">
                                                <div class="avatar">
                                                    <img src="{{ asset('index_template/index/assets/images/avatar/avatar-box-03.jpg')}}" alt="Image">
                                                </div>
                                                <div class="info">
                                                    <span>Created by:</span>
                                                    <h6><a href="author-2.html">Cody Fisher</a> </h6>
                                    ...
                                    <div  class="swiper-slide">
                                        <div class="tf-card-box style-1">
                                            <div class="card-media">
                                                <a href="#">
                                                    <img src="{{ asset('index_template/index/assets/images/box-item/card-item-04.jpg')}}" alt="">
                                                </a>
                                                <span class="wishlist-button icon-heart"></span>
                                                <div class="featured-countdown">
                                                    <span class="js-countdown" data-timer="7500" data-labels="d,h,m,s"></span>
                                            ...
                                            <div class="author flex items-center">
                                                <div class="avatar">
                                                    <img src="{{ asset('index_template/index/assets/images/avatar/avatar-box-04.jpg')}}" alt="Image">
                                                </div>
                                                <div class="info">
                                                    <span>Created by:</span>
                                                    <h6><a href="author-2.html">Cody Fisher</a> </h6>
                                    ...
                                    <div  class="swiper-slide">
                                        <div class="tf-card-box style-1">
                                            ...
                                            <div class="author flex items-center">
                                                <div class="avatar">
                                                    <img src="{{ asset('index_template/index/assets/images/avatar/avatar-box-05.jpg')}}" alt="Image">
                                                </div>
                                                <div class="info">
                                                    <span>Created by:</span>
                                                    <h6><a href="author-2.html">Cody Fisher</a> </h6>
                                    ...
                                    <div  class="swiper-slide">
                                        <div class="tf-card-box style-1">
                                            ...
                                            <div class="author flex items-center">
                                                <div class="avatar">
                                                    <img src="{{ asset('index_template/index/assets/images/avatar/avatar-box-06.jpg')}}" alt="Image">
                                                </div>
                                                <div class="info">
                                                    <span>Created by:</span>
                                                    <h6><a href="author-2.html">Cody Fisher</a> </h6>
                                    ...
                                    <div  class="swiper-slide">
                                        <div class="tf-card-box style-1">
                                            ...
                                            <div class="author flex items-center">
                                                <div class="avatar">
                                                    <img src="{{ asset('index_template/index/assets/images/avatar/avatar-box-07.jpg')}}" alt="Image">
                                                </div>
                                                <div class="info">
                                                    <span>Created by:</span>
                                                    <h6><a href="author-2.html">Cody Fisher</a> </h6>
                            ...
                            <div class="swiper-container seller seller-slider2" data-swiper='{
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="tf-author-box text-center">
                                            <div class="author-avatar ">
                                                <img src="{{ asset('index_template/index/assets/images/avatar/avatar-01.png')}}" alt="" class="avatar">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tf-author-box text-center">
                                            <div class="author-avatar ">
                                                <img src="{{ asset('index_template/index/assets/images/avatar/avatar-02.png')}}" alt="" class="avatar">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tf-author-box text-center">
                                            <div class="author-avatar ">
                                                <img src="{{ asset('index_template/index/assets/images/avatar/avatar-03.png')}}" alt="" class="avatar">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tf-author-box text-center">
                                            <div class="author-avatar ">
                                                <img src="{{ asset('index_template/index/assets/images/avatar/avatar-04.png')}}" alt="" class="avatar">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tf-author-box text-center">
                                            <div class="author-avatar ">
                                                <img src="{{ asset('index_template/index/assets/images/avatar/avatar-05.png')}}" alt="" class="avatar">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tf-author-box text-center">
                                            <div class="author-avatar ">
                                                <img src="{{ asset('index_template/index/assets/images/avatar/avatar-06.png')}}" alt="" class="avatar">
                    ...
                    <div class="row">
                        ...
                        <div data-wow-delay="0s" class="wow fadeInUp col-xl-3 col-lg-4 col-md-6 col-sm-6">
                            <div class="tf-card-box style-1">
                                <div class="card-media">
                                    <a href="#">
                                        <img src="{{ asset('index_template/index/assets/images/box-item/card-item-05.jpg')}}" alt="">
                                    </a>
                                    <span class="wishlist-button icon-heart"></span>
                                    <div class="featured-countdown">
                                        <span class="js-countdown" data-timer="7500" data-labels="d,h,m,s"></span>
                        ...
                        <div data-wow-delay="0.1s" class="wow fadeInUp col-xl-3 col-lg-4 col-md-6 col-sm-6">
                            <div class="tf-card-box style-1">
                                <div class="card-media">
                                    <a href="#">
                                        <img src="{{ asset('index_template/index/assets/images/box-item/card-item-06.jpg')}}" alt="">
                                    </a>
                                    <span class="wishlist-button icon-heart"></span>
                                    <div class="featured-countdown">
                                        <span class="js-countdown" data-timer="7500" data-labels="d,h,m,s"></span>
                        ...
                        <div data-wow-delay="0.2s" class="wow fadeInUp col-xl-3 col-lg-4 col-md-6 col-sm-6">
                            <div class="tf-card-box style-1">
                                <div class="card-media">
                                    <a href="#">
                                        <img src="{{ asset('index_template/index/assets/images/box-item/card-item-07.jpg')}}" alt="">
                                    </a>
                                    <span class="wishlist-button icon-heart"></span>
                                    <div class="featured-countdown">
                                        <span class="js-countdown" data-timer="7500" data-labels="d,h,m,s"></span>
                        ...
                        <div data-wow-delay="0.3s" class="wow fadeInUp col-xl-3 col-lg-4 col-md-6 col-sm-6">
                            <div class="tf-card-box style-1">
                                <div class="card-media">
                                    <a href="#">
                                        <img src="{{ asset('index_template/index/assets/images/box-item/card-item-08.jpg')}}" alt="">
                                    </a>
                                    <span class="wishlist-button icon-heart"></span>
                                    <div class="featured-countdown">
                                        <span class="js-countdown" data-timer="7500" data-labels="d,h,m,s"></span>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="tf-author-box style-1 text-center flex">
                                    <div class="author-avatar ">
                                        <img src="{{ asset('index_template/index/assets/images/avatar/avatar-small-01.png')}}" alt="" class="avatar">
                                    </div>
                                    <div class="author-infor ">
                            ...
                            <div class="swiper-slide">
                                <div class="tf-author-box style-1 text-center flex">
                                    <div class="author-avatar ">
                                        <img src="{{ asset('index_template/index/assets/images/avatar/avatar-small-02.png')}}" alt="" class="avatar">
                                    </div>
                                    <div class="author-infor ">
                            ...
                            <div class="swiper-slide">
                                <div class="tf-author-box style-1 text-center flex">
                                    <div class="author-avatar ">
                                        <img src="{{ asset('index_template/index/assets/images/avatar/avatar-small-03.png')}}" alt="" class="avatar">
                                    </div>
                                    <div class="author-infor ">
                            ...
                            <div class="swiper-slide">
                                <div class="tf-author-box style-1 text-center flex">
                                    <div class="author-avatar ">
                                        <img src="{{ asset('index_template/index/assets/images/avatar/avatar-small-04.png')}}" alt="" class="avatar">
                                    </div>
                                    <div class="author-infor ">
                                ...
                                <div class="swiper-wrapper">
                                        ...
                                        <div class="tf-card-collection">
                                            <a href="author-2.html">
                                                <div class="media-images-collection">
                                                    <img src="{{ asset('index_template/index/assets/images/box-item/img-collection-01.jpg')}}" alt="">
                                                    <img src="{{ asset('index_template/index/assets/images/box-item/img-collection-02.jpg')}}" alt="">
                                                    <img src="{{ asset('index_template/index/assets/images/box-item/img-collection-03.jpg')}}" alt="">
                                                    <img src="{{ asset('index_template/index/assets/images/box-item/img-collection-04.jpg')}}" alt="">
                                                    <div class="author-poster">
                                                        <img src="{{ asset('index_template/index/assets/images/avatar/avatar-03.png')}}" alt="" class="w-full">
                                                    </div>
                                                </div>
                                            </a>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tf-card-collection">
                                            <a href="author-2.html">
                                                <div class="media-images-collection">
                                                    <img src="{{ asset('index_template/index/assets/images/box-item/img-collection-05.jpg')}}" alt="">
                                                    <img src="{{ asset('index_template/index/assets/images/box-item/img-collection-06.jpg')}}" alt="">
                                                    <img src="{{ asset('index_template/index/assets/images/box-item/img-collection-07.jpg')}}" alt="">
                                                    <img src="{{ asset('index_template/index/assets/images/box-item/img-collection-08.jpg')}}" alt="">
                                                    <div class="author-poster">
                                                        <img src="{{ asset('index_template/index/assets/images/avatar/avatar-01.png')}}" alt="" class="w-full">
                                                    </div>
                                                </div>
                                            </a>
                                            <div class="card-bottom">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tf-card-collection">
                                            <a href="author-2.html">
                                                <div class="media-images-collection">
                                                    <img src="{{ asset('index_template/index/assets/images/box-item/img-collection-09.jpg')}}" alt="">
                                                    <img src="{{ asset('index_template/index/assets/images/box-item/img-collection-10.jpg')}}" alt="">
                                                    <img src="{{ asset('index_template/index/assets/images/box-item/img-collection-11.jpg')}}" alt="">
                                                    <img src="{{ asset('index_template/index/assets/images/box-item/img-collection-12.jpg')}}" alt="">
                                                    <div class="author-poster">
                                                        <img src="{{ asset('index_template/index/assets/images/avatar/avatar-02.png')}}" alt="" class="w-full">
                                                    </div>
                                                </div>
                                            </a>
                                            <div class="card-bottom">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tf-card-collection">
                                            <a href="author-2.html">
                                                <div class="media-images-collection">
                                                    <img src="{{ asset('index_template/index/assets/images/box-item/img-collection-13.jpg')}}" alt="">
                                                    <img src="{{ asset('index_template/index/assets/images/box-item/img-collection-14.jpg')}}" alt="">
                                                    <img src="{{ asset('index_template/index/assets/images/box-item/img-collection-15.jpg')}}" alt="">
                                                    <img src="{{ asset('index_template/index/assets/images/box-item/img-collection-16.jpg')}}" alt="">
                                                    <div class="author-poster">
                                                        <img src="{{ asset('index_template/index/assets/images/avatar/avatar-03.png')}}" alt="" class="w-full">
                                                    </div>
                                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="tf-box-icon relative text-center">
                                <div class="image">
                                    <img src="{{ asset('index_template/index/assets/images/box-icon/icon-01.png')}}" alt="">
                                    <p>Step 1</p>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="tf-box-icon relative text-center type-1">
                                <div class="image">
                                    <img src="{{ asset('index_template/index/assets/images/box-icon/icon-02.png')}}" alt="">
                                    <p>Step 2</p>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="tf-box-icon relative text-center">
                                <div class="image">
                                    <img src="{{ asset('index_template/index/assets/images/box-icon/icon-03.png')}}" alt="">
                                    <p>Step 3</p>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="tf-box-icon relative text-center">
                                <div class="image">
                                    <img src="{{ asset('index_template/index/assets/images/box-icon/icon-04.png')}}" alt="">
                                    <p>Step 4</p>
                                </div>
                            ...
                            <div class="action__body">
                                ...
                                <div class="bg-home7">
                                    <div class="swiper-container autoslider3reverse" data-swiper='{
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <img src="{{ asset('index_template/index/assets/images/item-background/bg-action-1.png')}}" alt="">
                                            </div>
                                            <div class="swiper-slide">
                                                <img src="{{ asset('index_template/index/assets/images/item-background/bg-action-1.png')}}" alt="">
                                            </div>
