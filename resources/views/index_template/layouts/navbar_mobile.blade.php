                ...
                <div class="mobile-nav-wrap">
                    ...
                    <div class="inner-mobile-nav">
                        <a href="index.html" rel="home" class="main-logo">
                            <img id="mobile-logo_header" src="{{ asset('index_template/index/assets/images/logo/logo.png')}}" data-retina="{{ asset('index_template/index/assets/images/logo/logo@2x.png')}}">
                        </a>
