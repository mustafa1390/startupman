        <div class="header home">
            <div class="header-content">
                ...
                @elseif ($notif->activition=='depo_wallet'||$notif->activition=='withr_wallet')
                @php $route_nav = route('admin.wallet.show',[  $notif->form_data_list_id ]);  @endphp
                @else
                ...
                @endif
											...
											<li>
												...
												<div class="timeline-panel">
													<div class="media-body">
                                                        @include('admin.layouts.table.avatar', [ 'avatarimage' => $notif->user->image ,
                                                        'class'=>'' , 'style' => 'width: 30px;height: 30px;'  ])

                                                        <span class="ms-2"  style="float: right;!important">{{$notif->user->name}} ({{name_type($notif->activition)}}) </span>
                                                        <small class="d-block" style="float: right;!important">{{ date_frmat($notif->created_at) }}</small>
                                                    </div>
                                    ...
                                    {{-- <a href="{{route('admin.task.index' , [ 'unread' ] )}}" class="all-notification">مشاهده همه</a> --}}
                                    <a href="{{route('admin.task.index'   )}}" class="all-notification">مشاهده همه</a>
                                 </div>
                            </li>
                                ...
                                <div class="dropdown-menu dropdown-menu-end of-visible"  >
                                    <div id="DZ_W_Notification3" class="widget-media dlab-scroll p-3" >
										<ul class="timeline">
											<li>
												<div class="timeline-panel">
                                                        <a class="dropdown-item"  onclick="document.location='/lang/fa'"  >{{__("Farsi")}}(fa)
                                                        <img src="{{ asset('img/fa.png')}}" style="width: 30px; height: 20px;" /></a>
												</div>
											</li>
                                            <li>
												<div class="timeline-panel">
                                                        <a class="dropdown-item"  onclick="document.location='/lang/en'">{{__("English")}}(en)
                                                            <img src="{{ asset('img/en.png')}}" style="width: 30px; height: 20px;" /></a>
												</div>
											</li>
                                        </ul>
                                    </div>
                            ...
                            <li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link  menu-wallet" href="javascript:void(0);" role="button">
									<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="32px" height="32px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
										<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
											<rect x="0" y="0" width="24" height="24"></rect>
											<rect fill="#fff" x="4" y="4" width="7" height="7" rx="1.5"></rect>
											<path d="M5.5,13 L9.5,13 C10.3284271,13 11,13.6715729 11,14.5 L11,18.5 C11,19.3284271 10.3284271,20 9.5,20 L5.5,20 C4.67157288,20 4,19.3284271 4,18.5 L4,14.5 C4,13.6715729 4.67157288,13 5.5,13 Z M14.5,4 L18.5,4 C19.3284271,4 20,4.67157288 20,5.5 L20,9.5 C20,10.3284271 19.3284271,11 18.5,11 L14.5,11 C13.6715729,11 13,10.3284271 13,9.5 L13,5.5 C13,4.67157288 13.6715729,4 14.5,4 Z M14.5,13 L18.5,13 C19.3284271,13 20,13.6715729 20,14.5 L20,18.5 C20,19.3284271 19.3284271,20 18.5,20 L14.5,20 C13.6715729,20 13,19.3284271 13,18.5 L13,14.5 C13,13.6715729 13.6715729,13 14.5,13 Z" fill="#fff" opacity="0.3"></path>
										</g>
									</svg>
                                </a>
							</li>
							...
							<li>
								<div class="dropdown header-profile2">
										...
										<div class="header-info2 d-flex align-items-center">
											<div class="d-flex align-items-center sidebar-info">
												<div>
													...
													<span class="d-block text-end"> {{auth()->guard('admin')->user()->email}}</span>
												</div>
											</div>
											{{-- <img src="{{ asset('tem_jid_rtl/myrtl_files/user.jpg')}}" alt=""> --}}
                                            @php
                                            if(auth()->guard('admin')->user()->image!=' '){
                                                $imadmin = auth()->guard('admin')->user()->image;
                                            }else{
                                                $imadmin = asset('tem_jid_rtl/myrtl_files/user.jpg');
                                            }
                                            @endphp
                                            @include('admin.layouts.table.avatar', [ 'avatarimage' => $imadmin  , 'class'=>'' , 'style' => ''  ])
										</div>
									</a>
									...
									<div class="dropdown-menu dropdown-menu-end">
										...
										<a href="a" class="dropdown-item ai-icon ">
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
													<rect x="0" y="0" width="24" height="24"></rect>
											...
											<span class="ms-2">{{ __("Support") }} </span>
										</a>
			...
			<div class="page-titles">
				<div class="sub-dz-head">
					<div class="d-flex align-items-center dz-head-title">
						<p class="ms-2 fs-20 text-warning">خدمات کامپلکس ارزی</p>
                        &nbsp;
						<h2 class="text-white m-0">Arzi.Co</h2>
					</div>
