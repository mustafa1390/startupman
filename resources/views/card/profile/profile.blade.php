                                        ...
                                        <form class="forms-sample" method="POST"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="exampleInputcodemeli">کدملی  </label>
                                                        <input type="text" class="form-control"
                                                            id="exampleInputcodemeli" autocomplete="off"
                                                            placeholder=" کدملی" name="codemeli"
                                                            @if ($admin->codemeli) value="{{ $admin->codemeli }}"@else value="{{ old('codemeli') }}" @endif  >
                                                    </div>
...
<div class="form-group">
                                                    @include('admin.layouts.table.avatar', [$admin , 'avatarimage' => $admin->image , 'class'=>'profile-pic' , 'style' => 'height: 160px;width: 160px; border-radius:50%;'  ])
...
@include('admin.layouts.table.avatar', [$admin , 'avatarimage' => $admin->image , 'class'=>'profile-pic' , 'style' => 'height: 160px;width: 160px; border-radius:50%;'  ])
 ...
 @include('card.multi_crop.cropper' , [   'name_file'=>'بارگزاری عکس' ,'name'=>'image' ,
//  'path_file'=> '' ,
 'type_upluad'=> 'single_upload' ,
 'path_file'=> $admin->image ,
