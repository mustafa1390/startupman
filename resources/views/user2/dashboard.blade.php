@component('user2.layouts.content', [
    'title' => 'ایجاد ادمین جدید',
    'tabTitle' => 'ایجاد ادمین جدید',
    'breadcrumb' => [['title' => 'لیست مدیران', 'url' => route('admin.dashboard')], ['title' => 'ایجاد ادمین جدید', 'class'
    => 'active']],
    ])

    @slot('style')
    @endslot
<div class="tf-section action top">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="action__body style-1">
                                    <div class="tf-tsparticles">
                                        <div id="tsparticles2" data-color="#5e5e5e" data-line="#5e5e5e"></div>
                                    </div>
                                    <h2 data-wow-delay="0s" class="wow fadeInUp">Join the world’s largest nFT community &amp; start collecting NFTS</h2>
                                    <p data-wow-delay="0.1s" class="wow fadeInUp">Discover the Most Premium, Unique and Exclusive <br> NFT Collection</p>
                                    <div data-wow-delay="0.2s" class="wow fadeInUp flat-button flex">
                                        <a href="#" class="tf-button style-1 h50 w230 mr-10">Create your first NFT<i class="icon-arrow-up-right2"></i></a>
                                        <a href="#" class="tf-button style-1 h50 w190 active ">Explore now<i class="icon-arrow-up-right2"></i></a>
                                    </div>
                                    <img src="{{ asset('index_template/index/assets/images/item-background/bg-home6.png')}}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-card-box style-1">
                                                <div class="card-media">
                                                    <a href="#">
                                                        <img src="{{ asset('index_template/index/assets/images/box-item/card-item-42.jpg')}}" alt="">
                                                    </a>
                                                    <span class="wishlist-button icon-heart"></span>
                                                    <div class="featured-countdown">
                                                        <span class="js-countdown" data-timer="7500" data-labels="d,h,m,s"><div aria-hidden="true" class="countdown__timer"><span class="countdown__item" style="display: none;"><span class="countdown__value countdown__value--0 js-countdown__value--0">0</span><span class="countdown__label">d</span></span><span class="countdown__item"><span class="countdown__value countdown__value--1 js-countdown__value--1">02</span><span class="countdown__label">h</span></span><span class="countdown__item"><span class="countdown__value countdown__value--2 js-countdown__value--2">03</span><span class="countdown__label">m</span></span><span class="countdown__item"><span class="countdown__value countdown__value--3 js-countdown__value--3">43</span><span class="countdown__label">s</span></span></div></span>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-card-box style-1">
                                                <div class="card-media">
                                                    <a href="#">
                                                        <img src="{{ asset('index_template/index/assets/images/box-item/card-item-47.jpg')}}" alt="">
                                                    </a>
                                                    <span class="wishlist-button icon-heart"></span>
                                                    <div class="featured-countdown">
                                                        <span class="js-countdown" data-timer="7500" data-labels="d,h,m,s"><div aria-hidden="true" class="countdown__timer"><span class="countdown__item" style="display: none;"><span class="countdown__value countdown__value--0 js-countdown__value--0">0</span><span class="countdown__label">d</span></span><span class="countdown__item"><span class="countdown__value countdown__value--1 js-countdown__value--1">02</span><span class="countdown__label">h</span></span><span class="countdown__item"><span class="countdown__value countdown__value--2 js-countdown__value--2">03</span><span class="countdown__label">m</span></span><span class="countdown__item"><span class="countdown__value countdown__value--3 js-countdown__value--3">43</span><span class="countdown__label">s</span></span></div></span>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-card-box style-1">
                                                <div class="card-media">
                                                    <a href="#">
                                                        <img src="{{ asset('index_template/index/assets/images/box-item/card-item-44.jpg')}}" alt="">
                                                    </a>
                                                    <span class="wishlist-button icon-heart"></span>
                                                    <div class="featured-countdown">
                                                        <span class="js-countdown" data-timer="7500" data-labels="d,h,m,s"><div aria-hidden="true" class="countdown__timer"><span class="countdown__item" style="display: none;"><span class="countdown__value countdown__value--0 js-countdown__value--0">0</span><span class="countdown__label">d</span></span><span class="countdown__item"><span class="countdown__value countdown__value--1 js-countdown__value--1">02</span><span class="countdown__label">h</span></span><span class="countdown__item"><span class="countdown__value countdown__value--2 js-countdown__value--2">03</span><span class="countdown__label">m</span></span><span class="countdown__item"><span class="countdown__value countdown__value--3 js-countdown__value--3">43</span><span class="countdown__label">s</span></span></div></span>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-card-box style-1">
                                                <div class="card-media">
                                                    <a href="#">
                                                        <img src="{{ asset('index_template/index/assets/images/box-item/card-item-45.jpg')}}" alt="">
                                                    </a>
                                                    <span class="wishlist-button icon-heart"></span>
                                                    <div class="featured-countdown">
                                                        <span class="js-countdown" data-timer="7500" data-labels="d,h,m,s"><div aria-hidden="true" class="countdown__timer"><span class="countdown__item" style="display: none;"><span class="countdown__value countdown__value--0 js-countdown__value--0">0</span><span class="countdown__label">d</span></span><span class="countdown__item"><span class="countdown__value countdown__value--1 js-countdown__value--1">02</span><span class="countdown__label">h</span></span><span class="countdown__item"><span class="countdown__value countdown__value--2 js-countdown__value--2">03</span><span class="countdown__label">m</span></span><span class="countdown__item"><span class="countdown__value countdown__value--3 js-countdown__value--3">43</span><span class="countdown__label">s</span></span></div></span>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-card-box style-1">
                                                <div class="card-media">
                                                    <a href="#">
                                                        <img src="{{ asset('index_template/index/assets/images/box-item/card-item-48.jpg')}}" alt="">
                                                    </a>
                                                    <span class="wishlist-button icon-heart"></span>
                                                    <div class="featured-countdown">
                                                        <span class="js-countdown" data-timer="7500" data-labels="d,h,m,s"><div aria-hidden="true" class="countdown__timer"><span class="countdown__item" style="display: none;"><span class="countdown__value countdown__value--0 js-countdown__value--0">0</span><span class="countdown__label">d</span></span><span class="countdown__item"><span class="countdown__value countdown__value--1 js-countdown__value--1">02</span><span class="countdown__label">h</span></span><span class="countdown__item"><span class="countdown__value countdown__value--2 js-countdown__value--2">03</span><span class="countdown__label">m</span></span><span class="countdown__item"><span class="countdown__value countdown__value--3 js-countdown__value--3">43</span><span class="countdown__label">s</span></span></div></span>
                ...
                <div class="tf-section seller ">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="swiper-container seller seller-slider3" data-swiper='{
                                    "loop":false,
                                    "slidesPerView": 1,
                                    "observer": true,
                                    "observeParents": true,
                        ...
                        <div class="row">
                            ...
                            <div data-wow-delay="0.1s" class="wow fadeInUp col-lg-3 col-md-6">
                                <div class="tf-box-icon style-1 step2 relative">
                                    ...
                                    <h4 class="heading"><a href="contact-us.html">Create collection</a></h4>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="heading-section pb-30">
                                    <h2 class="tf-title ">Hot bids</h2>
                                    <a href="explore-3.html" class="">View all bids <i class="icon-arrow-right2"></i></a>
                                </div>
                            </div>
                                ...
                                <div class="wrap-box-card style-1">
                                    <div data-wow-delay="0s" class="wow fadeInUp col-item">
                                        <div class="tf-card-box style-1">
                                            <div class="card-media">
                                                <a href="#">
                                                    <img src="{{ asset('index_template/index/assets/images/box-item/card-item-41.jpg')}}" alt="">
                                                </a>
                                                <span class="wishlist-button icon-heart"></span>
                                                <div class="featured-countdown">
                                                    <span class="js-countdown" data-timer="7500" data-labels="d,h,m,s"><div aria-hidden="true" class="countdown__timer"><span class="countdown__item" style="display: none;"><span class="countdown__value countdown__value--0 js-countdown__value--0">0</span><span class="countdown__label">d</span></span><span class="countdown__item"><span class="countdown__value countdown__value--1 js-countdown__value--1">02</span><span class="countdown__label">h</span></span><span class="countdown__item"><span class="countdown__value countdown__value--2 js-countdown__value--2">03</span><span class="countdown__label">m</span></span><span class="countdown__item"><span class="countdown__value countdown__value--3 js-countdown__value--3">43</span><span class="countdown__label">s</span></span></div></span>
                                    ...
                                    <div data-wow-delay="0.1s" class="wow fadeInUp col-item">
                                        <div class="tf-card-box style-1">
                                            <div class="card-media">
                                                <a href="#">
                                                    <img src="{{ asset('index_template/index/assets/images/box-item/card-item-42.jpg')}}" alt="">
                                    ...
                                    <div data-wow-delay="0.2s" class="wow fadeInUp col-item">
                                        <div class="tf-card-box style-1">
                                            <div class="card-media">
                                                <a href="#">
                                                    <img src="{{ asset('index_template/index/assets/images/box-item/card-item-43.jpg')}}" alt="">
                                                </a>
                                                <span class="wishlist-button icon-heart"></span>
                                                <div class="featured-countdown">
                                                    <span class="js-countdown" data-timer="7500" data-labels="d,h,m,s"><div aria-hidden="true" class="countdown__timer"><span class="countdown__item" style="display: none;"><span class="countdown__value countdown__value--0 js-countdown__value--0">0</span><span class="countdown__label">d</span></span><span class="countdown__item"><span class="countdown__value countdown__value--1 js-countdown__value--1">02</span><span class="countdown__label">h</span></span><span class="countdown__item"><span class="countdown__value countdown__value--2 js-countdown__value--2">03</span><span class="countdown__label">m</span></span><span class="countdown__item"><span class="countdown__value countdown__value--3 js-countdown__value--3">43</span><span class="countdown__label">s</span></span></div></span>
                                    ...
                                    <div data-wow-delay="0.3s" class="wow fadeInUp col-item">
                                        <div class="tf-card-box style-1">
                                            <div class="card-media">
                                                <a href="#">
                                                    <img src="{{ asset('index_template/index/assets/images/box-item/card-item-44.jpg')}}" alt="">
                                    ...
                                    <div data-wow-delay="0.4s" class="wow fadeInUp col-item">
                                        <div class="tf-card-box style-1">
                                            <div class="card-media">
                                                <a href="#">
                                                    <img src="{{ asset('index_template/index/assets/images/box-item/card-item-45.jpg')}}" alt="">
                                    ...
                                    <div class="swiper-wrapper">
                                            ...
                                            <div class="tf-card-collection">
                                                <a href="author-2.html">
                                                    <div class="media-images-collection">
                                                        <img src="{{ asset('index_template/index/assets/images/box-item/img-collection-29.jpg')}}" alt="">
                                                        <img src="{{ asset('index_template/index/assets/images/box-item/img-collection-30.jpg')}}" alt="">
                                                        <img src="{{ asset('index_template/index/assets/images/box-item/img-collection-31.jpg')}}" alt="">
                                                        <img src="{{ asset('index_template/index/assets/images/box-item/img-collection-32.jpg')}}" alt="">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-card-collection">
                                                <a href="author-2.html">
                                                    <div class="media-images-collection">
                                                        <img src="{{ asset('index_template/index/assets/images/box-item/img-collection-33.jpg')}}" alt="">
                                                        <img src="{{ asset('index_template/index/assets/images/box-item/img-collection-34.jpg')}}" alt="">
                                                        <img src="{{ asset('index_template/index/assets/images/box-item/img-collection-35.jpg')}}" alt="">
                                                        <img src="{{ asset('index_template/index/assets/images/box-item/img-collection-36.jpg')}}" alt="">
                                                        <div class="author-poster">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-card-collection">
                                                <a href="author-2.html">
                                                    <div class="media-images-collection">
                                                        <img src="{{ asset('index_template/index/assets/images/box-item/img-collection-37.jpg')}}" alt="">
                                                        <img src="{{ asset('index_template/index/assets/images/box-item/img-collection-38.jpg')}}" alt="">
                                                        <img src="{{ asset('index_template/index/assets/images/box-item/img-collection-39.jpg')}}" alt="">
                                                        <img src="{{ asset('index_template/index/assets/images/box-item/img-collection-40.jpg')}}" alt="">
                                                        <div class="author-poster">
